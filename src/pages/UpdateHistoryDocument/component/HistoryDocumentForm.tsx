...
const HistoryDocumentForm: React.FC<HistoryDocumentFormProps> = ({
  periods,
  onCreateDocument,
  loading,
  initialValues,
  ...
  // Khi initialValues thay đổi (từ API), reset lại form
  useEffect(() => {
    if (initialValues) {
      reset(initialValues);
    }
  ...
  useEffect(() => {
    documentTypesApi.getDocumentTypes().then((res: any) => setTypes(res.data));
  }, []);
...
export default HistoryDocumentForm;
